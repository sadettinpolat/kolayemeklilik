...
begin
Emekli.PrimOdemeGunSayisi := 6999;  //7000 gün lazým
emekli.Cinsiyet := cnErkek;
emekli.DogumTarihi := StrToDate('01.01.1980');
emekli.SigortaliBaslangicTarihi :=StrToDate('01.01.2006');
Check(emekli.EmeklilikDurumunuHesapla=false,'Emekli hesaplama metodu yanlýþ çalýþýyor');
end;
...
Check(emekli.EmeklilikDurumunuHesapla=false,'yanlýþ çalýþýyor_2');
end;
...
Check(emekli.EmeklilikDurumunuHesapla,'yanlýþ çalýþýyor_3');
...
emekli.SigortaliBaslangicTarihi :=StrToDate('08.09.1976');
Check(emekli.EmeklilikDurumunuHesapla,'yanlýþ çalýþýyor');
end;
...
emekli.DogumTarihi := StrToDate('01.01.1950');
Emekli.PrimOdemeGunSayisi := 5000;  // 5000 olmasi lazim
Check(emekli.EmeklilikDurumunuHesapla,'yanlýþ çalýþýyor_1');
emekli.SigortaliBaslangicTarihi :=StrToDate('23.05.1979');
Check(emekli.EmeklilikDurumunuHesapla,'yanlýþ çalýþýyor_2');
end;
